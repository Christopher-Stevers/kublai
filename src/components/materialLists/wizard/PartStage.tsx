...
>) {
  ...
  const reorderHandle = (
    <div
      className="pointer-events-none flex h-9 w-9 items-center justify-center rounded-full border border-gray-200 bg-white/95 text-gray-700 shadow-sm dark:bg-card/95"
      aria-hidden="true"
    >
